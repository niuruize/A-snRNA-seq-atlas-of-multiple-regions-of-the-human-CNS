...
#读取数据
load("~/Downloads/scRNA/AD_aging/GSE178146_ACC/GSE178146_ACC.RData")
load("~/Downloads/scRNA/AD_aging/PMID34582785_sACC/PMID34582785_ACC.RData")
load("~/Downloads/scRNA/AD_aging/PRJNA434002_ACC/PRJNA434002_ACC.RData")

#数据整理
GSE178146_ACC = subset(GSE178146_ACC, DoubletFinder == "Singlet")
PMID34582785_ACC = subset(PMID34582785_ACC, DoubletFinder == "Singlet")
PRJNA434002_ACC = subset(PRJNA434002_ACC, DoubletFinder == "Singlet")

#合并数据
scRNA = merge(GSE178146_ACC, y=c(PMID34582785_ACC,PRJNA434002_ACC))
rm(GSE178146_ACC,PMID34582785_ACC,PRJNA434002_ACC)
...
ggsave("ACC_1_1.pdf", p1, width = 40, height = 40, units = "cm")
...
ggsave("ACC_2_1.pdf", width = 30, height = 25, units = "cm")
...
##
###为分群重新指定细胞类型 
current.cluster.ids <- c("Br5161_ACC", "Br5212_ACC", "Br5400_ACC", "SRR14808188", "SRR14808189", "SRR14808211", "SRR14808212", "SRR14808213", "SRR14808214", "SRR14808215","SRR9262919","SRR9262941")
...
markers.to.plot <- c("RBFOX1","SNAP25","SLC17A7","CAMK2A","GAD1","GAD2",
                     "GFAP","AQP4","CSF1R","CD74","VCAN","SOX6","BCAS1","PLP1","MBP","FLT1","CLDN5","DCN","COL1A2")
...
save(scRNA,file="/Users/niuruize/Downloads/scRNA/AD_aging/aging/ACC/Seurat/scRNA_ACC_seurat.RData")
